export function Hero() {
  return (
    <div className="px-8 pt-6 max-w-3xl">
      ...
      <p className="mt-4 text-base leading-relaxed">
        I like building things that are actually useful for developers in real life — tools, automations, or anything that makes workflows easier. Still learning, still experimenting.
      </p>
    </div>
  );
}
